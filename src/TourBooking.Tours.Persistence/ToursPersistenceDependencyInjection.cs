...
public static class ToursPersistenceDependencyInjection
{
    ...
    /// named "tourbooking". It also adds scoped services for <see cref="IUnitOfWork"/> and <see
    ...
    /// </summary>
    /// <remarks>This method adds the <see cref="ToursDbContext"/> to the application builder using the
    /// "tourbooking" connection string. Additionally, it registers the <see cref="IMigrationManager"/> service with a
